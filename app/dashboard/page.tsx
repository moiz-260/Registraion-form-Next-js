                ...
                <div className="hero-content" style={{ width: '100%', maxWidth: '600px' }}>
                    ...
                    <div className="feature-card" style={{
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '120px 1fr', gap: '0.5rem 1rem', width: '100%', alignItems: 'center' }}>
                            ...
                            <span style={{ color: 'var(--slate-900)' }}>{profile?.full_name || name}</span>

                            <span style={{ fontWeight: 600, color: 'var(--slate-600)' }}>Email:</span>
                            <span style={{ color: 'var(--slate-900)' }}>{profile?.email || user.email}</span>

                            <span style={{ fontWeight: 600, color: 'var(--slate-600)' }}>Phone:</span>
                            <span style={{ color: 'var(--slate-900)' }}>{profile?.phone || "N/A"}</span>

                            <span style={{ fontWeight: 600, color: 'var(--slate-600)' }}>Age:</span>
                            <span style={{ color: 'var(--slate-900)' }}>{profile?.age || "N/A"}</span>

                            <span style={{ fontWeight: 600, color: 'var(--slate-600)' }}>Gender:</span>
                            <span style={{ color: 'var(--slate-900)' }}>{profile?.gender || "N/A"}</span>

                            <span style={{ fontWeight: 600, color: 'var(--slate-600)' }}>Date of Birth:</span>
                            <span style={{ color: 'var(--slate-900)' }}>{profile?.date_of_birth || "N/A"}</span>

                            <span style={{ fontWeight: 600, color: 'var(--slate-600)' }}>Address:</span>
                            <span style={{ color: 'var(--slate-900)' }}>{profile?.address || "N/A"}</span>

                            <span style={{ fontWeight: 600, color: 'var(--slate-600)' }}>City:</span>
                            <span style={{ color: 'var(--slate-900)' }}>{profile?.city || "N/A"}</span>

                            <span style={{ fontWeight: 600, color: 'var(--slate-600)' }}>Country:</span>
                            <span style={{ color: 'var(--slate-900)' }}>{profile?.country || "N/A"}</span>
                        </div>
                    </div>
